...
//   // --- EN-TÊTE ÉCOLE (LOGIQUE DYNAMIQUE) ---
//   if (schoolInfo?.logo) {
//     try {
//       doc.addImage(schoolInfo.logo, 'PNG', 14, 10, 25, 25);
//     } catch (e) {
//       console.warn("Logo invalide ou inaccessible");
//     }
//   }
...
//   doc.setFontSize(9);
//   doc.setFont('helvetica', 'normal');
//   doc.text(schoolInfo?.address || "Adresse non définie", 45, 24);
//   doc.text(`Tél: ${schoolInfo?.phone || '--'}`, 45, 29);
//   doc.text(`Email: ${schoolInfo?.email || '--'}`, 45, 34);
...
//   doc.text(`ÉLÈVE : ${report.studentName.toUpperCase()}`, 14, 60);
//   doc.setFont('helvetica', 'normal');
//   doc.text(`Année Scolaire : ${report.academicYearName || 'N/A'}`, 140, 60);
...
//     theme: 'grid',
//     headStyles: { 
//       fillColor: [33, 37, 41], // Fond Sombre (Anthracite)
//       textColor: [255, 255, 255], 
//       fontSize: 10,
//       halign: 'center'
//     },
...
//   doc.setFontSize(11);
//   doc.setFont('helvetica', 'bold');
//   doc.text(`MOYENNE GÉNÉRALE : ${report.average} / 20`, 20, finalY + 8);

//   // --- SIGNATURES ---
//   const sigY = finalY + 30;
//   doc.setFont('helvetica', 'normal');
//   doc.text("Le Parent d'élève", 30, sigY);
//   doc.text("Le Directeur", 150, sigY);
